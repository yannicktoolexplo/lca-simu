# Étape 2 V8 — runbook V2 additif

Ce runbook remplace uniquement la cible d'exécution du runbook V1 : le V1 est
conservé comme preuve de la tentative interrompue. La relance officielle, ses
résultats et tous ses livrables utilisent des chemins V2 distincts. Cette étape
lit la validation scientifique V7 et la campagne V8, sans modifier V7, V4 ni les
cartes existantes.

Le watcher n'est pas armé par ce document. Tant que la campagne V8 V2 et sa
finalisation ne sont pas complètes, il ne doit produire aucun résultat aval.
