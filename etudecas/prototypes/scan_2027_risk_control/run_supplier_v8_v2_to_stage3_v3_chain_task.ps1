...
param(
    ...
    [string]$Stage3GoFile = "C:\dev\lca-simu-pr40-validation-artifacts-20260726\supplier_v8_stage3_go_20260906_v3.json",
    [string]$ChainSupervisionDir = "C:\dev\lca-simu-pr40-validation-artifacts-20260726\supplier_v8_v2_to_stage3_v3_chain_supervision_20260906_v1",
...
$SchemaVersion = "etudecas.supplier_v8_v2_to_stage3_v3_chain.v1"
...
function Read-AndValidateStage3Go {
    ...
    if ((Get-JsonProperty $go "decision") -ne "GO_STAGE3_V3") {
        throw "La décision indépendante Stage3 n'est pas GO_STAGE3_V3."
    }
...
try {
    ...
    $finalizerArguments = @(
        "-m",
        "etudecas.prototypes.scan_2027_risk_control.finalize_supplier_operating_point_full_campaign_v8",
        "--campaign-root", (Get-FullPath $CampaignRoot),
