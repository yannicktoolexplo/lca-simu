...
- `etudecas/Prediction`: POC de prediction supervisee sur historique synthetique.
- `etudecas/supplier_risk_kpi`: MVP KPI construit depuis les sorties de simulation reelles.
...
- les sorties `supplier_risk_kpi` viennent des simulations locales et donnent un panel hebdomadaire plus operationnel;
...
| fichier | role |
| --- | --- |
| `etudecas/Prediction/run_prediction_poc.py` | genere l'historique synthetique, entraine le modele, calibre les probabilites, score les couples et exporte les resultats |
| `etudecas/Prediction/data/synthetic_supplier_item_history.csv` | historique hebdomadaire synthetique fournisseur-article-site |
| `etudecas/Prediction/result/prediction_test_scored_rows.csv` | lignes du jeu de test avec probabilites predites |
| `etudecas/Prediction/result/predicted_supplier_item_risk.csv` | derniere photo par couple fournisseur-article-site |
| `etudecas/Prediction/result/predicted_supplier_risk.csv` | aggregation fournisseur |
| `etudecas/Prediction/result/evaluation_metrics.json` | metriques de validation |
| `etudecas/Prediction/result/model_feature_coefficients.csv` | coefficients du modele logistique |
| `etudecas/Prediction/result/prediction_poc_report.md` | rapport synthetique genere |

### Supplier Risk KPI

| fichier | role |
| --- | --- |
| `etudecas/supplier_risk_kpi/build_supplier_risk_kpi.py` | construit les KPI hebdomadaires depuis les sorties simulation |
| `etudecas/supplier_risk_kpi/result/data/supplier_item_week_panel.csv` | panel hebdomadaire complet fournisseur-article-site |
| `etudecas/supplier_risk_kpi/result/data/supplier_item_risk_kpi.csv` | derniere photo KPI par couple |
| `etudecas/supplier_risk_kpi/result/data/supplier_risk_kpi.csv` | aggregation fournisseur |
| `etudecas/supplier_risk_kpi/result/summaries/supplier_risk_kpi_summary.json` | metadata, compteurs et normalisateurs |
| `etudecas/supplier_risk_kpi/result/reports/supplier_risk_kpi_report.md` | rapport metier court |
...
- `etudecas/supplier_risk_kpi/result/summaries/supplier_risk_kpi_summary.json`
- `etudecas/supplier_risk_kpi/result/data/supplier_risk_kpi.csv`
- `etudecas/supplier_risk_kpi/result/data/supplier_item_risk_kpi.csv`
- `etudecas/supplier_risk_kpi/result/data/supplier_item_week_panel.csv`
...
1. `etudecas/Prediction/data/synthetic_supplier_item_history.csv`
2. `etudecas/Prediction/result/prediction_test_scored_rows.csv`
3. `etudecas/Prediction/result/predicted_supplier_item_risk.csv`
4. `etudecas/Prediction/result/model_feature_coefficients.csv`
5. `etudecas/supplier_risk_kpi/result/data/supplier_item_week_panel.csv`
6. `etudecas/supplier_risk_kpi/result/data/supplier_item_risk_kpi.csv`
7. `etudecas/supplier_risk_kpi/result/data/supplier_risk_kpi.csv`
8. `etudecas/supplier_risk_kpi/result/summaries/supplier_risk_kpi_summary.json`
9. `etudecas/Prediction/run_prediction_poc.py`
10. `etudecas/supplier_risk_kpi/build_supplier_risk_kpi.py`
...
- etudecas/Prediction/data/synthetic_supplier_item_history.csv
- etudecas/Prediction/result/prediction_test_scored_rows.csv
- etudecas/Prediction/result/model_feature_coefficients.csv
- etudecas/supplier_risk_kpi/result/data/supplier_item_week_panel.csv
- etudecas/supplier_risk_kpi/result/data/supplier_item_risk_kpi.csv
