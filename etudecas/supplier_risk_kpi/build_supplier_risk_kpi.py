#!/usr/bin/env python3
"""Build supplier risk KPI panels from etudecas simulation outputs.
...
DEFAULT_SIM_RESULT_DIR = (
    ...
    / "simulation"
    / "result"
    / "reference_baseline_real_demand_target_calibrated_mrp_lot_policy_recalibrated_5y"
)
DEFAULT_SENSITIVITY_DIR = ROOT.parent / "simulation" / "sensibility" / "active_supplier_parameter_result"
