...
from analysis_batch_common import apply_scales, load_json, run_simulation, to_float, write_json
...
SUPPLIER_CAPACITY_OVERRIDES = {
    "SDC-VD0901566A": {
        # Keep this packaging supplier in the same operating band as the other
        # packaging source feeding M-1810. At 10k/day it is permanently binding
        # and forces a flat shipment profile that is not credible given the
