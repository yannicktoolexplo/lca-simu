...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "reliability, quality, cost. Empty or 'all' preserves the historical "
    ...
    for day in range(total_timeline_days):
        ...
        if (
            ...
            for src_pair, policy in estimated_source_policies.items():
                ...
                external_pipeline[ext_arrival_day].append((src_pair[0], src_pair[1], ext_receipt_qty))
        ...
        "policy": {
            ...
            **(
            ...
            "supplier_state_dependent_risk": {
                ...
                "excluded_families": [
                    family
                    for family in SUPPLIER_STATE_RISK_FAMILIES
                    if family not in args.supplier_state_risk_families
                ],
                "family_filter_mode": (
                    "all"
                    if tuple(args.supplier_state_risk_families)
                    == SUPPLIER_STATE_RISK_FAMILIES
                    else "allowlist"
                ),
                "observation_warmup_days": max(0, int(args.supplier_state_risk_observation_warmup_days or 0)),
                "stock_rules": (
                    ...
                    if "stock" in args.supplier_state_risk_families
                    else []
                ),
                "capacity_rules": (
                    [
                    ...
                    if "capacity" in args.supplier_state_risk_families
                    else []
                ),
                "lead_rules": (
                    [
                    ...
                    if "lead" in args.supplier_state_risk_families
                    else []
                ),
                "upstream_rules": (
                    [
                    ...
                    if "upstream" in args.supplier_state_risk_families
                    else []
                ),
                "reliability_quality_rules": [
                    *(
                        ...
                        if "reliability" in args.supplier_state_risk_families
                        else []
                    ),
                    *(
                        [
                        ...
                        if "quality" in args.supplier_state_risk_families
                        else []
                    ),
                ],
                "cost_rule": (
                    "upstream recourse cost ratio > 250% for 3 days -> upstream recourse cost x1.10 for 14 days"
                    if "cost" in args.supplier_state_risk_families
                    else ""
                ),
                "state_effect_caps": (
