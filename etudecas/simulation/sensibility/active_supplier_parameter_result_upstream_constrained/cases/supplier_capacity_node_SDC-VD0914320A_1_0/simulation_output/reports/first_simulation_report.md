...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_upstream_constrained\cases\supplier_capacity_node_SDC-VD0914320A_1_0\input_case.json
- Scenario: scn:BASE
