...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_upstream_constrained\cases\external_procurement_lead_days_scale_1_0\input_case.json
- Scenario: scn:BASE
