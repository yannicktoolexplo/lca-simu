...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_upstream_constrained\cases\supplier_stock_node_SDC-VD0949099A_1_0\input_case.json
- Scenario: scn:BASE
