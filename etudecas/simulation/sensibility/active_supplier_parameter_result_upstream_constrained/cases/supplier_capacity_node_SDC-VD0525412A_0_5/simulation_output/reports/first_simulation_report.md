...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_upstream_constrained\cases\supplier_capacity_node_SDC-VD0525412A_0_5\input_case.json
- Scenario: scn:BASE
