...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_reliability_scale_0_95\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 32854
...
- Total shipped: 793940309.1466
- Avg inventory: 665857654.7904
- Ending inventory: 662272117.7963
- Transport cost: 5538265.6497
- Holding cost (capital tied-up): 7788614.7224
- Warehouse operating cost: 10013933.2145
- Inventory risk cost (obsolescence/compliance proxy): 4450636.9842
- Legacy raw holding cost before split: 22253184.9212
- Purchase cost (from order_terms sell_price): 14918093.9299
- Production cost (pharma conversion proxy): 18304090.5003
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27791450.5709
- Total cost: 61013635.0012
- Total supplier upstream ordered qty: 549180735.3825
- Total supplier upstream arrived qty: 783978052.6546
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2079026551.0657
- Total supplier upstream cost premium: 54168229.3832
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.127654 / 0.164126 / 0.072945 / 0.090771 / 0.244504 / 0.3
...
- Total unreliable supplier loss qty: 33537750.0
- Total supplier capacity binding qty: 970001.0526
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 310000.0 | 305000.0 | 361 | 130000.0 | 61.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 1235000.0 | 125000.0 | 51 | 365000.0 | 25.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1810 | 338928 | 25000.0 | 425000.0 | 200000.0 | 1128 | 375000.0 | 8.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 5847.0 | 141656.0 | 1072 | 6650.0 | 141656.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
