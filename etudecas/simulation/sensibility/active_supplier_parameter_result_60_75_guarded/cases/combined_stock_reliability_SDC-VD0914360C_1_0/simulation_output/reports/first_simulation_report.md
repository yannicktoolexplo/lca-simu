...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\combined_stock_reliability_SDC-VD0914360C_1_0\input_case.json
- Scenario: scn:BASE
...
- Total shipped: 822588639.1842
- Avg inventory: 663044918.1738
- Ending inventory: 618896335.7366
- Transport cost: 5544236.4865
- Holding cost (capital tied-up): 7763263.8122
- Warehouse operating cost: 9981339.1872
- Inventory risk cost (obsolescence/compliance proxy): 4436150.7499
- Legacy raw holding cost before split: 22180753.7493
- Purchase cost (from order_terms sell_price): 14789241.328
- Production cost (pharma conversion proxy): 18220384.9559
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27724990.2358
- Total cost: 60734616.5197
- Total supplier upstream ordered qty: 549319233.3228
- Total supplier upstream arrived qty: 713764670.5949
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2070821436.7476
- Total supplier upstream cost premium: 54670592.9133
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.127823 / 0.164343 / 0.073042 / 0.091286 / 0.243506 / 0.3
...
- Total unreliable supplier loss qty: 781200.0
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 305000.0 | 255000.0 | 1640 | 130000.0 | 51.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1430 | 042342 | 30000000.0 | 30000000.0 | 90000000.0 | 1791 | 120000000.0 | 3.0 | Lot FIA tres eleve a valider avec l'industriel. |
...
| M-1810 | 693055 | 1.0 | 5847.0 | 144245.0 | 1077 | 6650.0 | 144245.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
