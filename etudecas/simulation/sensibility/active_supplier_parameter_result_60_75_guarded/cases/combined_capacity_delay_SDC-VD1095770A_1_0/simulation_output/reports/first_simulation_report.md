...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\combined_capacity_delay_SDC-VD1095770A_1_0\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 32712
...
- Total shipped: 823828290.8813
- Avg inventory: 664233986.0598
- Ending inventory: 618977592.4134
- Transport cost: 5542495.982
- Holding cost (capital tied-up): 7768680.2307
- Warehouse operating cost: 9988303.1538
- Inventory risk cost (obsolescence/compliance proxy): 4439245.8461
- Legacy raw holding cost before split: 22196229.2306
- Purchase cost (from order_terms sell_price): 15068982.6679
- Production cost (pharma conversion proxy): 18346160.5202
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27738725.2125
- Total cost: 61153868.4006
- Total supplier upstream ordered qty: 546750223.4904
- Total supplier upstream arrived qty: 711426803.2157
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2084459570.9988
- Total supplier upstream cost premium: 53507264.8657
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.127035 / 0.163331 / 0.072591 / 0.090632 / 0.246411 / 0.3
- Total opening stock bootstrap qty: 0.0
- Total explicit initialization stock qty: 754600.0
- Total explicit initialization pipeline qty: 303602519.9729
- Total opening open-order qty: 68338188.0
- Total unreliable supplier loss qty: 0.0
- Total supplier capacity binding qty: 773626.9333
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 290000.0 | 354 | 125000.0 | 58.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1810 | 693055 | 1.0 | 5847.0 | 142931.0 | 1077 | 6650.0 | 142931.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
...
| M-1430 | 734545 | 6300.0 | 25200.0 | 6300.0 | -6 | 6300.0 | 1.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
