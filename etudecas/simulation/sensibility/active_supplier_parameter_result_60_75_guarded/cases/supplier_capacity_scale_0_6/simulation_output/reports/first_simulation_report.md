...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_capacity_scale_0_6\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 12229
...
- Total shipped: 84650617.9552
- Avg inventory: 526909198.3737
- Ending inventory: 499870995.0125
- Transport cost: 1446133.6102
- Holding cost (capital tied-up): 7631536.678
- Warehouse operating cost: 9811975.7289
- Inventory risk cost (obsolescence/compliance proxy): 4360878.1017
- Legacy raw holding cost before split: 21804390.5086
- Purchase cost (from order_terms sell_price): 4096829.7104
- Production cost (pharma conversion proxy): 11720294.4982
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 23250524.1188
- Total cost: 39067648.3274
- Total supplier upstream ordered qty: 13162928.9694
- Total supplier upstream arrived qty: 248421100.9423
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 50174354.9703
- Total supplier upstream cost premium: 4278711.9814
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.195342 / 0.251153 / 0.111624 / 0.037016 / 0.104865 / 0.3
...
- Total supplier capacity binding qty: 66227621655.3361
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 125000.0 | 359 | 130000.0 | 25.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 935000.0 | 110000.0 | 46 | 280000.0 | 22.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1430 | 344135 | 120000.0 | 3480000.0 | 480000.0 | 15 | 1320000.0 | 4.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 338928 | 25000.0 | 400000.0 | 75000.0 | -3 | 375000.0 | 3.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 5847.0 | 36206.0 | 89 | 7770.0 | 36206.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1430 | 734545 | 6300.0 | 18900.0 | 6300.0 | -6 | 12600.0 | 1.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
