...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_reliability_node_SDC-VD0914360C_0_95\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 32826
...
- Total shipped: 822226635.0422
- Avg inventory: 662877481.1795
- Ending inventory: 617262696.7488
- Transport cost: 5538510.7243
- Holding cost (capital tied-up): 7785371.1033
- Warehouse operating cost: 10009762.847
- Inventory risk cost (obsolescence/compliance proxy): 4448783.4876
- Legacy raw holding cost before split: 22243917.4379
- Purchase cost (from order_terms sell_price): 14755029.3037
- Production cost (pharma conversion proxy): 18230338.9139
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27782428.1621
- Total cost: 60767796.3797
- Total supplier upstream ordered qty: 547725944.335
- Total supplier upstream arrived qty: 711021381.6071
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2076325157.5957
- Total supplier upstream cost premium: 53842138.0402
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.128117 / 0.164722 / 0.07321 / 0.091142 / 0.24281 / 0.3
...
- Total unreliable supplier loss qty: 1321250.0
- Total supplier capacity binding qty: 877374.6842
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 310000.0 | 315000.0 | 359 | 130000.0 | 63.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1810 | 338928 | 25000.0 | 400000.0 | 175000.0 | 1142 | 375000.0 | 7.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 5847.0 | 143304.0 | 1073 | 6650.0 | 143304.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
