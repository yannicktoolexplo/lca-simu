...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\combined_stock_reliability_SDC-VD0520132A_1_0\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 34367
...
- Total shipped: 823566903.848
- Avg inventory: 664943404.1873
- Ending inventory: 619993896.5506
- Transport cost: 5539693.8437
- Holding cost (capital tied-up): 7772200.9397
- Warehouse operating cost: 9992829.7796
- Inventory risk cost (obsolescence/compliance proxy): 4441257.6798
- Legacy raw holding cost before split: 22206288.3991
- Purchase cost (from order_terms sell_price): 14816981.5318
- Production cost (pharma conversion proxy): 18241270.1891
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27745982.2428
- Total cost: 60804233.9638
- Total supplier upstream ordered qty: 545838871.1796
- Total supplier upstream arrived qty: 711434308.4516
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2083821561.1708
- Total supplier upstream cost premium: 53326201.7909
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.127823 / 0.164344 / 0.073042 / 0.091107 / 0.243683 / 0.3
...
- Total unreliable supplier loss qty: 4236.0
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 290000.0 | 352 | 120000.0 | 58.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 1170000.0 | 125000.0 | 48 | 350000.0 | 25.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 042342 | 30000000.0 | 30000000.0 | 60000000.0 | 0 | 90000000.0 | 2.0 | Lot FIA tres eleve a valider avec l'industriel. |
| M-1430 | 773474 | 1.0 | 9600000.0 | 1580586.0 | 8 | 1773464.0 | 1580586.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
...
| M-1810 | 693055 | 1.0 | 5847.0 | 145331.0 | 1059 | 7140.0 | 145331.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
