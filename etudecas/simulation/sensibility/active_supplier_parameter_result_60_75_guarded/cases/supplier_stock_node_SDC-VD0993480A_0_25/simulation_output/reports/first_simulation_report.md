...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_stock_node_SDC-VD0993480A_0_25\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 32781
...
- Total shipped: 823825019.1051
- Avg inventory: 663123774.3446
- Ending inventory: 620994828.2754
- Transport cost: 5542455.886
- Holding cost (capital tied-up): 7786456.0248
- Warehouse operating cost: 10011157.7461
- Inventory risk cost (obsolescence/compliance proxy): 4449403.4427
- Legacy raw holding cost before split: 22247017.2137
- Purchase cost (from order_terms sell_price): 15073387.139
- Production cost (pharma conversion proxy): 18369797.2451
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27789473.0996
- Total cost: 61232657.4837
- Total supplier upstream ordered qty: 549250826.3523
- Total supplier upstream arrived qty: 715206263.1336
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2085623254.8898
- Total supplier upstream cost premium: 53462987.8845
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.127162 / 0.163494 / 0.072664 / 0.090515 / 0.246166 / 0.3
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 305000.0 | 353 | 125000.0 | 61.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1430 | 344135 | 120000.0 | 1200000.0 | 480000.0 | 11 | 960000.0 | 4.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 5847.0 | 143166.0 | 1078 | 6650.0 | 143166.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
