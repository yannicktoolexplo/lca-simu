...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_reliability_scale_0_97\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 32958
...
- Total shipped: 804742455.6446
- Avg inventory: 673206995.605
- Ending inventory: 662940373.0757
- Transport cost: 5538646.9444
- Holding cost (capital tied-up): 7791246.2356
- Warehouse operating cost: 10017316.5886
- Inventory risk cost (obsolescence/compliance proxy): 4452140.706
- Legacy raw holding cost before split: 22260703.5302
- Purchase cost (from order_terms sell_price): 14725762.2951
- Production cost (pharma conversion proxy): 18225048.3299
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27799350.4746
- Total cost: 60750161.0996
- Total supplier upstream ordered qty: 551130987.4331
- Total supplier upstream arrived qty: 778605657.934
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2083881586.6481
- Total supplier upstream cost premium: 54674483.7261
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.128251 / 0.164894 / 0.073286 / 0.091171 / 0.242399 / 0.3
...
- Total unreliable supplier loss qty: 20041350.0
- Total supplier capacity binding qty: 827664.2612
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 305000.0 | 300000.0 | 352 | 130000.0 | 60.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 1210000.0 | 125000.0 | 51 | 365000.0 | 25.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 042342 | 30000000.0 | 30000000.0 | 90000000.0 | 1630 | 120000000.0 | 3.0 | Lot FIA tres eleve a valider avec l'industriel. |
...
| M-1810 | 693055 | 1.0 | 5847.0 | 142137.0 | 1074 | 6650.0 | 142137.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
