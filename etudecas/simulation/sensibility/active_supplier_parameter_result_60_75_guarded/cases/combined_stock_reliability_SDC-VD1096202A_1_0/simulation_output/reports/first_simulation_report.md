...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\combined_stock_reliability_SDC-VD1096202A_1_0\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 30539
...
- Total shipped: 817318202.6929
- Avg inventory: 662557653.7797
- Ending inventory: 618029007.7229
- Transport cost: 5452420.4824
- Holding cost (capital tied-up): 7603105.5285
- Warehouse operating cost: 9775421.3938
- Inventory risk cost (obsolescence/compliance proxy): 4344631.7306
- Legacy raw holding cost before split: 21723158.6529
- Purchase cost (from order_terms sell_price): 14080409.8626
- Production cost (pharma conversion proxy): 17681138.1419
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27175579.1352
- Total cost: 58937127.1398
- Total supplier upstream ordered qty: 539046341.9334
- Total supplier upstream arrived qty: 706316694.5811
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2045016797.4667
- Total supplier upstream cost premium: 50826717.649
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.129004 / 0.165862 / 0.073716 / 0.092512 / 0.238906 / 0.3
...
- Total unreliable supplier loss qty: 27.0
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 260000.0 | 1025 | 125000.0 | 52.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 1170000.0 | 110000.0 | 46 | 330000.0 | 22.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1810 | 338928 | 25000.0 | 400000.0 | 175000.0 | 380 | 400000.0 | 7.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 5847.0 | 107067.0 | 1143 | 7210.0 | 107067.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
