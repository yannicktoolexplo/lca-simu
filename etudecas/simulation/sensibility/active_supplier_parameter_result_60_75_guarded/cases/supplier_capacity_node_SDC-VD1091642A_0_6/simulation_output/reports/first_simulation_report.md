...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_capacity_node_SDC-VD1091642A_0_6\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 30610
...
- Total shipped: 815704883.6925
- Avg inventory: 663003375.1381
- Ending inventory: 616368694.857
- Transport cost: 5456233.4003
- Holding cost (capital tied-up): 7615422.2729
- Warehouse operating cost: 9791257.2081
- Inventory risk cost (obsolescence/compliance proxy): 4351669.8703
- Legacy raw holding cost before split: 21758349.3513
- Purchase cost (from order_terms sell_price): 13837452.7363
- Production cost (pharma conversion proxy): 17593729.4948
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27214582.7515
- Total cost: 58645764.9825
- Total supplier upstream ordered qty: 537442341.7571
- Total supplier upstream arrived qty: 704678929.7153
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2039075908.5037
- Total supplier upstream cost premium: 50475277.9705
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.129855 / 0.166956 / 0.074203 / 0.093037 / 0.23595 / 0.3
- Total opening stock bootstrap qty: 0.0
- Total explicit initialization stock qty: 754600.0
- Total explicit initialization pipeline qty: 303597371.1633
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 230000.0 | 1037 | 130000.0 | 46.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 1170000.0 | 130000.0 | 51 | 330000.0 | 26.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
...
| M-1430 | 344135 | 120000.0 | 4440000.0 | 360000.0 | -2 | 1440000.0 | 3.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 5847.0 | 108209.0 | 1142 | 6930.0 | 108209.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
