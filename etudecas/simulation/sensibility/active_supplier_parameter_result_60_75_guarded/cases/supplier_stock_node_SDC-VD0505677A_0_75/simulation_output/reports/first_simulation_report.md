...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_60_75_guarded\cases\supplier_stock_node_SDC-VD0505677A_0_75\input_case.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 32715
...
- Total shipped: 822855879.3274
- Avg inventory: 662052283.8368
- Ending inventory: 620537499.3592
- Transport cost: 5548576.5422
- Holding cost (capital tied-up): 7761962.4768
- Warehouse operating cost: 9979666.0417
- Inventory risk cost (obsolescence/compliance proxy): 4435407.1296
- Legacy raw holding cost before split: 22177035.6481
- Purchase cost (from order_terms sell_price): 14780925.1399
- Production cost (pharma conversion proxy): 18217087.4272
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 27725612.1903
- Total cost: 60723624.7575
- Total supplier upstream ordered qty: 545144121.3909
- Total supplier upstream arrived qty: 710664558.6629
- Supplier upstream arrived includes opening upstream pipeline receipts when the upstream pipeline seed is enabled.
- Total supplier upstream rejected qty (cap-limited): 2059825778.4371
- Total supplier upstream cost premium: 52786677.4062
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase / production: 0.127824 / 0.164346 / 0.073043 / 0.091374 / 0.243413 / 0.3
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 295000.0 | 280000.0 | 358 | 125000.0 | 56.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 1170000.0 | 115000.0 | 43 | 360000.0 | 23.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 042342 | 30000000.0 | 30000000.0 | 60000000.0 | 1 | 90000000.0 | 2.0 | Lot FIA tres eleve a valider avec l'industriel. |
...
| M-1810 | 693055 | 1.0 | 5847.0 | 147822.0 | 1116 | 6230.0 | 147822.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1810 | 338928 | 25000.0 | 400000.0 | 125000.0 | 1093 | 375000.0 | 5.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
