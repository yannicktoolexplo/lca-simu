...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_external_procurement_leads\cases\supplier_capacity_node_SDC-VD0505677A_0_1\input_case.json
- Scenario: scn:BASE
