...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_external_procurement_leads\cases\supplier_stock_node_SDC-VD0990780A_1_0\input_case.json
- Scenario: scn:BASE
