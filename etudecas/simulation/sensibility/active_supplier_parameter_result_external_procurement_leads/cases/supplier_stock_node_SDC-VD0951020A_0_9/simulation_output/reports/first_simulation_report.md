...
## Run setup
- Input: etudecas\simulation\sensibility\active_supplier_parameter_result_external_procurement_leads\cases\supplier_stock_node_SDC-VD0951020A_0_9\input_case.json
- Scenario: scn:BASE
