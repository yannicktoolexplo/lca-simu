...
from etudecas.simulation.analysis_batch_common import apply_scales, load_json, run_simulation, write_json
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Source simulation-ready graph JSON from the active reference-baseline prep step.",
    )
    parser.add_argument(
        "--output-graph",
    ...
    parser.add_argument(
        "--output-dir",
        default="etudecas/simulation/result/stage_reference_baseline_real_demand_target_calibrated",
        help="Optional stage output directory if you run this calibration step with simulation enabled.",
    )
