...
## Run setup
- Input: etudecas\simulation_prep\result\reference_baseline\_mrp_bom_tests\bom_weekly_mps_lotified_fallback_physical_floor.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 76816
...
- Fill rate: 1.0
- Ending backlog: 0
- Total produced: 119029000.0
- Total shipped: 828225398.069
- Avg inventory: 303554542.4123
- Ending inventory: 291147572.9206
- Transport cost: 24968163.9272
- Holding cost (capital tied-up): 106859795.1964
- Warehouse operating cost: 137391165.2526
- Inventory risk cost (obsolescence/compliance proxy): 61062740.1122
- Legacy raw holding cost before split: 305313700.5612
- Purchase cost (from order_terms sell_price): 169188770.9032
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 330281864.4885
- Total cost: 499470635.3917
- Total external procured ordered qty: 423290225.6455
- Total external procured arrived qty: 423290104.6763
- Total external procured rejected qty (cap-limited): 354846086.7637
- Total external procurement cost premium: 128549928.1865
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase: 0.213946 / 0.275074 / 0.122255 / 0.049989 / 0.338736
...
- Total supplier capacity binding qty: 2378976687.2838
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1810 | 338929 | 5000.0 | 0.0 | 80000.0 | -35 | 3400000.0 | 16.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 333362 | 5000.0 | 3910000.0 | 70000.0 | 11 | 1755000.0 | 14.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 042342 | 30000000.0 | 60000000.0 | 60000000.0 | -13 | 180000000.0 | 2.0 | Lot FIA tres eleve a valider avec l'industriel. |
| M-1430 | 773474 | 1.0 | 1227940.0 | 2156818.0 | 1267 | 10795855.0 | 2156818.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1430 | 344135 | 120000.0 | 840000.0 | 240000.0 | 10 | 480000.0 | 2.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 0.0 | 28647.0 | 50 | 1023209.0 | 28647.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1430 | 038005 | 10000.0 | 70000.0 | 20000.0 | -171 | 160000.0 | 2.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
...
- maps/supply_graph_poc_geocoded_map_with_factory_hover.html (etudecas\simulation\result\mrp_bom_test_weekly_mps_lotified_fallback_physical_floor\maps\supply_graph_mrp_bom_test_weekly_mps_lotified_fallback_physical_floor.html)
