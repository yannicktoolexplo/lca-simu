...
- Applied factory lot-execution policy: `{'M-1430': {'item:268967': {'max_lots_per_week': 10, 'source': 'industrial_confirmation_2026-04-13'}}, 'M-1810': {'item:268091': {'max_lots_per_week': 10, 'source': 'industrial_confirmation_2026-04-13'}}, 'SDC-1450': {'item:773474': {'max_lots_per_week': 10, 'source': 'working_assumption_align_factory_lot_execution', 'inject_capacity_from_lot_week': False}}}`
...
## Availability KPI
- item:268091: objective `14.0 j`, avg demand `9798.5/j`, avg coverage `13.5 j`, ending coverage `20.7 j`, days >= objective `39.5%`
- item:268967: objective `14.0 j`, avg demand `4317.8/j`, avg coverage `23.8 j`, ending coverage `19.8 j`, days >= objective `74.8%`

## Factory Plan Adherence
- M-1430: adherence executable plan `100.0%`, lot uplift vs desired `1029.7%`, plan gap `0.0`, input-shortage days `0.0%`, weekly-lot-limit days `0.0%`, capacity days `0.0%`
- M-1810: adherence executable plan `100.0%`, lot uplift vs desired `48.3%`, plan gap `0.0`, input-shortage days `0.0%`, weekly-lot-limit days `0.0%`, capacity days `0.0%`
- SDC-1450: adherence executable plan `100.0%`, lot uplift vs desired `60.5%`, plan gap `0.0`, input-shortage days `0.0%`, weekly-lot-limit days `0.0%`, capacity days `0.0%`

## Cost KPI
- Inventory cost: `78616808.4455`
- Transport cost: `1143534.8731`
- Total logistics cost: `79760343.3186`
...
- item:268091: days >= objective `-0.3 pts`, ending coverage `-1.7 j`
...
- Costs: inventory `+161849.5`, transport `-12476.5`, total `+546200.0`
