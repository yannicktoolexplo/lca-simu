...
## Run setup
- Input: etudecas\simulation_prep\result\reference_baseline\_mrp_bom_tests\bom_weekly_mps_lotified_no_static_fallback.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 182360

## KPIs
- Total demand: 25762139.9999
- Total served: 23132317.9999
- Fill rate: 0.897919
- Ending backlog: 2629822.0
- Total produced: 93238000.0
- Total shipped: 704271813.5924
- Avg inventory: 246166261.3015
- Ending inventory: 229554614.3176
- Transport cost: 20077382.8191
- Holding cost (capital tied-up): 66740835.8697
- Warehouse operating cost: 85809646.1182
- Inventory risk cost (obsolescence/compliance proxy): 38137620.497
- Legacy raw holding cost before split: 190688102.485
- Purchase cost (from order_terms sell_price): 178604475.0066
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 210765485.3041
- Total cost: 389369960.3107
- Total external procured ordered qty: 368735930.9207
- Total external procured arrived qty: 368728058.0995
- Total external procured rejected qty (cap-limited): 307625017.6229
- Total external procurement cost premium: 166188224.3279
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase: 0.171407 / 0.220381 / 0.097947 / 0.051564 / 0.458701
...
- Total supplier capacity binding qty: 181959255.6581
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1430 | 042342 | 30000000.0 | 60000000.0 | 30000000.0 | -24 | 30000000.0 | 1.0 | Lot FIA tres eleve a valider avec l'industriel. |
| M-1430 | 773474 | 1.0 | 0.0 | 273890.0 | 532 | 0.0 | 273890.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1430 | 344135 | 120000.0 | 840000.0 | 240000.0 | 20 | 600000.0 | 2.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1430 | 333362 | 5000.0 | 3910000.0 | 50000.0 | -14 | 920000.0 | 10.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1430 | 038005 | 10000.0 | 70000.0 | 10000.0 | -90 | 60000.0 | 1.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 0.0 | 4539.0 | 368 | 0.0 | 4539.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
...
- maps/supply_graph_poc_geocoded_map_with_factory_hover.html (etudecas\simulation\result\mrp_bom_test_weekly_mps_lotified_no_fallback\maps\supply_graph_mrp_bom_test_weekly_mps_lotified_no_fallback.html)
