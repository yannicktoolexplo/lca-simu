...
## Run setup
- Input: etudecas\simulation_prep\result\reference_baseline\_mrp_bom_tests\bom_weekly_fallback_physical_floor.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 155806
...
- Total produced: 107213037.7668
- Total shipped: 727249412.5287
- Avg inventory: 301561628.4885
- Ending inventory: 299131007.1803
- Transport cost: 20154736.8447
- Holding cost (capital tied-up): 98493179.646
- Warehouse operating cost: 126634088.1163
- Inventory risk cost (obsolescence/compliance proxy): 56281816.9406
- Legacy raw holding cost before split: 281409084.7029
- Purchase cost (from order_terms sell_price): 67709580.9912
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 301563821.5476
- Total cost: 369273402.5388
- Total external procured ordered qty: 399841606.3646
- Total external procured arrived qty: 399841606.3646
- Total external procured rejected qty (cap-limited): 866820614.9621
- Total external procurement cost premium: 60064922.8153
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase: 0.266722 / 0.342928 / 0.152412 / 0.054579 / 0.183359
...
- Total supplier capacity binding qty: 177674608.4281
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1430 | 333362 | 5000.0 | 0.0 | 100000.0 | 119 | 0.0 | 20.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1810 | 338929 | 5000.0 | 0.0 | 95000.0 | 213 | 0.0 | 19.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 042342 | 30000000.0 | 30000000.0 | 60000000.0 | -14 | 210000000.0 | 2.0 | Lot FIA tres eleve a valider avec l'industriel. |
| M-1430 | 773474 | 1.0 | 209261.0 | 2852145.0 | 148 | 132168.0 | 2852145.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| SDC-1450 | 021081 | 20000.0 | 42979.0 | 21467.0 | 244 | 228459.0 | 1.073 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 0.0 | 17609.0 | 218 | 0.0 | 17609.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
...
- maps/supply_graph_poc_geocoded_map_with_factory_hover.html (etudecas\simulation\result\mrp_bom_test_weekly_fallback_physical_floor\maps\supply_graph_mrp_bom_test_weekly_fallback_physical_floor.html)
