...
## Run setup
- Input: etudecas\simulation_prep\result\reference_baseline\_mrp_bom_tests\bom_monthly_no_static_fallback.json
- Scenario: scn:BASE
...
- MRP demand signal smoothing / static fallback on propagated pairs: 30 j / False
...
- maps/supply_graph_poc_geocoded_map_with_factory_hover.html (etudecas\simulation\result\mrp_bom_test_monthly\maps\supply_graph_mrp_bom_test_monthly.html)
