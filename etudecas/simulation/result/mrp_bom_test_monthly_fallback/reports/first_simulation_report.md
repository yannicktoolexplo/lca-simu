...
## Run setup
- Input: etudecas\simulation_prep\result\reference_baseline\_mrp_bom_tests\bom_monthly_static_fallback.json
- Scenario: scn:BASE
...
- MRP demand signal smoothing / static fallback on propagated pairs: 30 j / True
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 158238

## KPIs
- Total demand: 25762139.9999
- Total served: 13425233.2978
- Fill rate: 0.521123
- Ending backlog: 12336906.7021
- Total produced: 56686467.0121
- Total shipped: 413002711.4909
- Avg inventory: 200815792.6125
- Ending inventory: 118444629.1024
- Transport cost: 6591200.4381
- Holding cost (capital tied-up): 55266497.1676
- Warehouse operating cost: 71056924.9297
- Inventory risk cost (obsolescence/compliance proxy): 31580855.5243
- Legacy raw holding cost before split: 157904277.6217
- Purchase cost (from order_terms sell_price): 20710442.701
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 164495478.0598
- Total cost: 185205920.7607
- Total external procured ordered qty: 86003970.01
- Total external procured arrived qty: 86003970.01
- Total external procured rejected qty (cap-limited): 170847161.9175
- Total external procurement cost premium: 15035452.2195
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase: 0.298406 / 0.383664 / 0.170518 / 0.035588 / 0.111824
- Total opening stock bootstrap qty: 0.0
- Total explicit initialization stock qty: 272324445.993
...
|---|---:|---:|---:|---:|---:|---:|---|
| finished_good | DC-1920 | item:268091 | 20.0 | 6765.095238 | 135301.904765 | 101476.428574 | UN |
| finished_good | DC-1920 | item:268967 | 25.0 | 4271.019048 | 106775.476196 | 80081.607147 | UN |
...
| M-1430 | 773474 | 1.0 | 0.0 | 72335.0 | 558 | 0.0 | 72335.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| SDC-1450 | 021081 | 20000.0 | 44011.0 | 20181.0 | -12 | 38540.0 | 1.009 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 0.0 | 2585.0 | 712 | 0.0 | 2585.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
...
- maps/supply_graph_poc_geocoded_map_with_factory_hover.html (etudecas\simulation\result\mrp_bom_test_monthly_fallback\maps\supply_graph_mrp_bom_test_monthly_fallback.html)
