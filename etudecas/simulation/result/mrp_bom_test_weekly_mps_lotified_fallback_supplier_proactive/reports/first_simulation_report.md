...
## Run setup
- Input: etudecas\simulation_prep\result\reference_baseline\_mrp_bom_tests\bom_weekly_mps_lotified_static_fallback.json
- Scenario: scn:BASE
...
- MRP trace tracked pairs / rows / orders: 65 / 118625 / 52087
...
- Total shipped: 809183147.1694
- Avg inventory: 309647581.6984
- Ending inventory: 320177650.7117
- Transport cost: 24506577.6986
- Holding cost (capital tied-up): 82236730.3101
- Warehouse operating cost: 105732938.9702
- Inventory risk cost (obsolescence/compliance proxy): 46992417.3201
- Legacy raw holding cost before split: 234962086.6004
- Purchase cost (from order_terms sell_price): 211230815.7784
- Logistics cost (transport + inventory capital + warehouse + inventory risk): 259468664.299
- Total cost: 470699480.0774
- Total external procured ordered qty: 461787563.8201
- Total external procured arrived qty: 461084138.9467
- Total external procured rejected qty (cap-limited): 381538296.6776
- Total external procurement cost premium: 194296858.6482
- Total estimated source ordered qty: 0.0
- Total estimated source replenished qty: 0.0
- Total estimated source rejected qty: 0.0
- Cost share capital holding / warehouse / inventory risk / transport / purchase: 0.174712 / 0.224629 / 0.099835 / 0.052064 / 0.448759
...
- Total supplier capacity binding qty: 2402888061.1323
...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| M-1430 | 333362 | 5000.0 | 3910000.0 | 75000.0 | 4 | 2010000.0 | 15.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1810 | 338929 | 5000.0 | 0.0 | 75000.0 | -58 | 4145000.0 | 15.0 | Concentration MRP a valider; plusieurs lots commandes le meme jour IMT. |
| M-1430 | 042342 | 30000000.0 | 60000000.0 | 30000000.0 | -24 | 60000000.0 | 1.0 | Lot FIA tres eleve a valider avec l'industriel. |
| M-1430 | 773474 | 1.0 | 0.0 | 273889.0 | 1624 | 0.0 | 273889.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1430 | 344135 | 120000.0 | 840000.0 | 240000.0 | 10 | 1080000.0 | 2.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
| M-1810 | 693055 | 1.0 | 0.0 | 29560.0 | 74 | 599723.0 | 29560.0 | Quantite standard=1 non interpretable comme lot industriel; lot/campagne interne a renseigner. |
| M-1430 | 038005 | 10000.0 | 70000.0 | 20000.0 | -36 | 190000.0 | 2.0 | Pic initial redate avant le 1er janvier via order_date_IMT; affichage MRP corrige. |
...
- maps/supply_graph_poc_geocoded_map_with_factory_hover.html (etudecas\simulation\result\mrp_bom_test_weekly_mps_lotified_fallback_supplier_proactive\maps\supply_graph_mrp_bom_test_weekly_mps_lotified_fallback_supplier_proactive.html)
