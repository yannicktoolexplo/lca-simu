...
- Detail CSV: `C:/dev/lca-simu/analysis/output8_GEO_link_integrity_audit.csv`
...
- Records needing a dotted bridge: 57
- Records missing T1: 11
- Records missing OEM: 0
- Status counts: continuous_direct=118, continuous_with_gap_bridge=57
- Missing-role counts: T2=47, T4=31, T1=11, T3=5
...
- R16 `Stowage assemblé avec porte` / `35NC6 (nickel-chrome)`: T4->T1 missing:T3,T2
