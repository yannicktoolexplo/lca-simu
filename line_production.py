...
aluminium_critial_stock = (((8/mean_frame) * num_frame +
                      (8/mean_armrest) * num_armrest) * 1) #2 days to deliver + 1 marging

foam_critical_stock = (((8/mean_frame) * num_frame +
                      (8/mean_armrest) * num_armrest) * 1) #1 day to deliver + 1 marging
fabric_critical_stock = (((8/mean_frame) * num_frame +
                      (8/mean_armrest) * num_armrest) * 1) #1 day to deliver + 1 marging

paint_critical_stock = (8/mean_paint) * num_paint  #1 day to deliver + 1 marging
...
class seat_Factory:
    ...
    def paint_stock_control(self, env):
        ...
        while True:
            ...
            time_paint.append(env.now/8)  # Update time vector for fabric   
