...
- Primary path CSV: `analysis/output8_GEO_primary_complete_component_path_audit.csv`
- All-supplier coverage CSV: `analysis/output8_GEO_primary_complete_all_coverage_audit.csv`
- Gap/action CSV: `analysis/output8_GEO_primary_complete_gap_actions.csv`
