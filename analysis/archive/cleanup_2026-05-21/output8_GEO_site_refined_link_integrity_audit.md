...
- Detail CSV: `analysis/output8_GEO_site_refined_link_integrity_audit.csv`
...
- Records audited: 173
- Complete T4->T3->T2->T1->OEM records: 87
- Records needing a dotted bridge: 56
- Records missing T1: 11
- Records missing OEM: 0
- Status counts: continuous_direct=117, continuous_with_gap_bridge=56
- Missing-role counts: T2=46, T4=34, T1=11, T3=10

## All Links

- Records audited: 173
- Complete T4->T3->T2->T1->OEM records: 88
- Records needing a dotted bridge: 55
- Records missing T1: 11
- Records missing OEM: 0
- Status counts: continuous_direct=118, continuous_with_gap_bridge=55
- Missing-role counts: T2=46, T4=34, T1=11, T3=8
