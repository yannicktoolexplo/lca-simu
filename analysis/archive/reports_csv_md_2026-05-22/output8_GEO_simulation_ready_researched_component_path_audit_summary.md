...
- Source JSON: `analysis/output8_GEO_normalized_simulation_ready_researched.json`
- Primary path CSV: `analysis/output8_GEO_simulation_ready_researched_primary_component_path_audit.csv`
- All-supplier coverage CSV: `analysis/output8_GEO_simulation_ready_researched_all_component_coverage_audit.csv`
- Gap/action CSV: `analysis/output8_GEO_simulation_ready_researched_component_tier_gap_actions.csv`
...
- Records audités: **170**
- Statuts parcours: complete_direct=170
- Gaps/actions: 
- Tiers concernés: 
...
- Records audités: **170**
- Statuts parcours/couverture: complete_direct=170
- Gaps/actions: 
